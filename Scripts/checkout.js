...
import { deliveryOptions } from "../data/DeliverOptions.js";
    ...
    const FormatedDtae = deliveryDate.format('dddd, MMMM D')
...
function deliveryOptionsHTML(matchingProduct, cartItem) {
    ...
    deliveryOptions.forEach((deliveryopt) => {
        ...
        const dateString = deliveryDate.format('dddd, MMMM D')
        const PriceString = deliveryopt.priceCents === 0 ? 'Free ' : `$${formatCurrency(deliveryopt.priceCents)} -`
        const isChecked = deliveryopt.id === cartItem.deliveryOptionsId
        html += `
